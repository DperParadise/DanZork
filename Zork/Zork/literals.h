...
#include <string>
	...
	std::string CELL_INIT_DESC = "There's an old dirty mattress and breadcrumbs on the floor,\na window to the west and an door to the east with an opening.";
	std::string CELL_MATTRESS = "Mattress";
	std::string CELL_LOOK_MATTRESS = "And old dirty mattres.";
	...
	std::string CELL_LOOK_PIGEON = "A young rock pigeon.";
	std::string CELL_PIGEON_BACK_TO_WINDOW = "The pigeon flies back to the window and start eating breadcrumbs again.";
	std::string CELL_BAR = "Bar";
	std::string CELL_LOOK_IRON_BAR = "A slightly rusty iron bar. It has fallen down from the window.";
	std::string CELL_BREADCRUMBS = "Breadcrumbs";
	std::string CELL_LOOK_BREADCRUMBS = "Breadcrumbs. Only an animal would eat this.";
	std::string CELL_LOOK_WINDOW_NO_BARS = "A window hole.";
	std::string CELL_WINDOW = "Window";
	std::string CELL_LOOK_WINDOW = "A barred window. The bars are old and rusty.You can hear birds singing outside near the window.";
	std::string CELL_LOOK_DOOR_OPENING = "A Door opening to give meals to prisoners. Through it you can see a\nguard sitting in a desk in the middle of an aisle. He wanders around and sits back again";
	std::string CELL_LOOK_DOOR_OPENING_GUARD_DEAD = "A Door opening to give meals to prisoners.";
	std::string CELL_DOOR_OPENING = "Opening";
	std::string CELL_LOOK_DOOR = "A door made of iron.";
	...
	std::string CELL_GUARD_ON_ENTER1 = " What the hell...";
	std::string CELL_GUARD_ON_ENTER2 = "The guard enters the cell: I'm gonna teach you games!.\nHe grabs you from the neck and throws you back to the cell. He leaves the cell.";
	std::string CELL_HIT_GUARD = "The guard enters the cell. You hit the guard in the head and he collapses.";
	std::string CELL_PIGEON_COMES_IN = "A pigeon comes into the cell!!";
	...
	std::string CELL_EXIT_WINDOW = "The woods outside the window.";
	...
	std::string GUARDROOM_KEY = "Guardroom key";
	std::string CLEANING_STAFF_KEY = "Cleaning staff key";
	std::string TOOLROOM_GUARD_ALIVE = "A cell guard.";
	std::string TOOLROOM_GUARD_DEAD = "The corpse of a dead guard";
	std::string GUARDROOM_TWOHANDED_MACE = "Two-handed mace";
	std::string GUARDROOM_LOOK_TWOHANDED_MACE = "A heavy two-handed iron mace with a long handle.";
	...
	std::string TOOLROOM_TWOHANDED_MACE = "Mace";
	...
	std::string DOOR_NEED_KEY = "You need a key to open this door.";
	std::string DOOR_OPEN = "The door is open.";
	...
	std::string DROP_ITEM = "Dropped.";
	std::string MAX_INV = "You can't carry more than five objects";
	std::string ENEMY_NOT_HERE = "There's no one to fight here";
	std::string DOOR_CLOSED = "The door is closed.";
	std::string WRONG_DIRECTION = "Wrong direction.";
	std::string CANT_PUT_ITEM_CLOSED = "The item is closed.";
	std::string CANT_PUT_ITEM_TOO_BIG = "The item is too big.";
	std::string LOOT = "Belongings taken.";
	std::string NO_SEARCH = "Not such a person to search.";
	std::string ALREADY_GOT_ITEM = "I've got that already!";
